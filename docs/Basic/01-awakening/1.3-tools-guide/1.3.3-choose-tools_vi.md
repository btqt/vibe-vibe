...
**Hành động bước đầu tiên**: Tham khảo [1.3.1](./1.3.1-tool-overview.md) chọn một công cụ, nhập "Giúp tôi làm một trang web hiển thị thời gian hiện tại", 1-2 phút sau là có thể thấy kết quả.
...
Công cụ cụ thể tham khảo [1.3.1 Lập trình AI trên nền tảng web](./1.3.1-tool-overview.md#lập-trình-ai-trên-nền-tảng-web-giải-pháp-một-cửa-không-cần-cài-đặt).
...
Tham khảo bảng so sánh [1.3.1 Trình soạn thảo mã AI](./1.3.1-tool-overview.md#trình-soạn-thảo-mã-ai-công-cụ-chuyên-nghiệp-cài-đặt-độc-lập), lựa chọn theo sở thích của bạn.
...
Công cụ cụ thể tham khảo [1.3.1 Plugin/Tiện ích mở rộng IDE](./1.3.1-tool-overview.md#plugin-tiện-ích-mở-rộng-ide-thêm-ai-cho-trình-soạn-thảo-hiện-có).
...
Công cụ cụ thể vui lòng tham khảo [1.3.1 Bức tranh toàn cảnh công cụ](./1.3.1-tool-overview.md).
